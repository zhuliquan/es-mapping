...
func TestLoadMappingFile(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        args{mappingPath: "./testdata/not_exists_mapping.json"},
			wantMapping: nil,
			wantErr:     true,
		},
		{
			name:        "test_wrong_mapping_file",
			args:        args{mappingPath: "./testdata/wrong_mapping.json"},
			wantMapping: nil,
			wantErr:     true,
		},
		{
			name: "test_load_alias_mapping",
			args: args{mappingPath: "./testdata/alias_mapping.json"},
			wantMapping: &Mapping{
		...
		},
		{
			...
			args:        args{mappingPath: "./testdata/wrong_alias_mapping.json"},
			wantMapping: nil,
			wantErr:     true,
		},
		{
			name: "test_load_keyword_mapping",
			args: args{mappingPath: "./testdata/keyword_mapping.json"},
			wantMapping: &Mapping{
				Source:  &Source{Enabled: true},
		...
		},
		{
			...
			args: args{mappingPath: "./testdata/object_mapping.json"},
			wantMapping: &Mapping{
		...
		},
		{
			...
			args: args{mappingPath: "./testdata/flattened_mapping.json"},
			wantMapping: &Mapping{
				Dynamic: BoolDynamic(true),
				Properties: map[string]*Property{
		...
		},
		{
			...
			args: args{mappingPath: "./testdata/nested_mapping.json"},
			wantMapping: &Mapping{
				Dynamic: BoolDynamic(true),
				Properties: map[string]*Property{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := LoadMappingFile(tt.args.mappingPath)
...
func TestMappingString(t *testing.T) {
	m, err := LoadMappingFile("./testdata/keyword_mapping.json")
	assert.Nil(t, err)
...
func TestGetProperty(t *testing.T) {
	pm, err := LoadMappingFile("./testdata/property_mapping.json")
	if err != nil {
